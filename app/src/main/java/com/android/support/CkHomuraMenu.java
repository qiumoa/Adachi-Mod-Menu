...
//        mExpanded.setBackground(gdMenuBody); //Apply GradientDrawable to it
        ...
        title.setText(Html.fromHtml("<b>Adachi-Menu</b>"));
        ...
        subTitle.setText(Html.fromHtml("<b><marquee><p style=\"font-size:30\"><p style=\"color:green;\">Mod</p> | AdachiSakura</p> </marquee></b>"));
